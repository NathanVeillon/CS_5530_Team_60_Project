...
public class Visit extends BaseObject {
	...
	public Visit setUserId(Integer userId) throws Exception {
	...
	public Visit setTemporaryHousingId(Integer temporaryHousingId) throws Exception {
	...
	public Visit setPeriodId(Integer periodId) throws Exception {
	...
	public Visit setCost(Integer cost) throws Exception {
		setField("Cost", cost);
		return this;
	}
	...
	public Visit setUser(main.java.models.User user) throws Exception {
	...
	public Visit setTemporaryHousing(main.java.models.TemporaryHousing temporaryHousing) throws Exception {
	...
	public Visit setPeriod(main.java.models.Period period) throws Exception {
