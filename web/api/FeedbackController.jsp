    ...
    switch (method) {
        ...
        case "POST":
            try {
                ...
                try {
                    newFeedback.fromFlatJsonMap(request.getParameterMap());
                } catch (Exception e) {
                    response.setStatus(400);
                ...
                User user = userQuery.filterByField("Id", newFeedback.getUserId()).findOne();
                TemporaryHousing temporaryHousing = temporaryHousingQuery
						.filterByField("Id", newFeedback.getTemporaryHousingId())
						.findOne();
                ...
                writer.append(newFeedback.toJson());
            } catch (Exception e) {
                response.setStatus(400);
                writer.append("Unexpected Error:");
                e.printStackTrace(writer);
